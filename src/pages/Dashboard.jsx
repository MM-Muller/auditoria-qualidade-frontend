...
function Dashboard() {
  // Busca os dados de NCs e Auditorias
    ...
    <div>
      ...
      <div className="dashboard-grid">
        <StatCard 
          ...
          color="#dc3545" // Vermelho para urgência
        />
        <StatCard 
          title="NCs Abertas" 
      ...
      <div className="dashboard-list-container">
        ...
        <ul className="dashboard-list">
          {ncsAtrasadas?.length > 0 ? (
            ...
            !isLoadingAtrasadas && <p>Nenhuma NC atrasada. Ótimo trabalho!</p>
          )}
        </ul>
      </div>
    </div>
